...
const userId = '112';
const userName = urlParams.get('name') || 'Guest Viewer';
const userToken = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyX2lkIjoiMTEyIn0.j-XS4N9B6KddPxX-CsHOZo-8lPj_ODu7nwwZy1_FPYQ';
    ...
    methods: {
        ...
        renderVideoStreams(call) {
            ...
            if (localVideoEl && call.camera.state.mediaStream) {
                // Keep the label, only replace video
